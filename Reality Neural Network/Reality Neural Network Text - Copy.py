...
for w in filtered_sentence:
    try:
        ...
        print("No, I don't know. Let's figure out some thing else!")
        print(w, " : ", "None")



dir_path = r'D:/Programming/Python/Artificial Intellligence/Deep Learning/Neural Network/Reality Neural Network/Data/'
...
for path in files:
    text_path = r'D:/Programming/Python/Artificial Intellligence/Deep Learning/Neural Network/Reality Neural Network/Data/' + path
    file = open(text_path, "r")
    text = file.read()

    file.close()
    print("\n\n\n\nSummary of " + path+ " : " + text)
